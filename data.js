// Region markers and freight-context callout copy.
// (NOAA outlook polygons live in /data/outlook-{temp,precip}.geojson —
//  see scripts/parse-outlook.mjs for the schema-stable shapefile parser.)
